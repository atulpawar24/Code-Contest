...
<body>
    <%
		...
		String BranchAddr=(String)request.getAttribute("BranchAddr");
		int BranchNum=(int)request.getAttribute("BranchNum");
	...
	<div class="container">
		<h2>Search Successful</h2>
		    <div class="form-group">
				...
				<label class="col-sm-10"><%out.print(BranchAddr); %></label>
		...
		<form class="form-horizontal">
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<button type="submit" formaction="map.jsp"
